...
import type { ExternalBlob as _ExternalBlob, Message as _Message, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async assignGroupAdmin(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignGroupAdmin(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createChat(arg0: Array<Principal>, arg1: boolean, arg2: string | null, arg3: ExternalBlob | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createChat(arg0, arg1, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteMessage(arg0: string, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async editMessage(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async enableUser(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getTotalMessageCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalMessageCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchMessages(arg0: string, arg1: string): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchMessages(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchUserByUsername(arg0: string): Promise<Principal | null> {
        if (this.processError) {
            try {
    ...
    async updateGroupSettings(arg0: string, arg1: string | null, arg2: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGroupSettings(arg0, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg1), await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        groupAvatar: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.groupAvatar)),
        chatId: value.chatId,
        groupName: record_opt_to_undefined(from_candid_opt_n22(_uploadFile, _downloadFile, value.groupName))
    };
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<{
    messages: Array<_Message>;
    groupAvatar: [] | [_ExternalBlob];
    chatId: string;
    groupName: [] | [string];
    ...
    return await Promise.all(value.map(async (x)=>await from_candid_record_n21(_uploadFile, _downloadFile, x)));
}
