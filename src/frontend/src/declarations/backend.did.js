...
export const idlService = IDL.Service({
  ...
  'deleteMessage' : IDL.Func([IDL.Text, IDL.Int, IDL.Bool], [], []),
  'disableUser' : IDL.Func([IDL.Principal], [], []),
  'editMessage' : IDL.Func([IDL.Text, IDL.Int, IDL.Text], [], []),
  'enableUser' : IDL.Func([IDL.Principal], [], []),
      ...
      [
        IDL.Vec(
          IDL.Record({
            ...
            'groupAvatar' : IDL.Opt(ExternalBlob),
            'chatId' : IDL.Text,
